...
function holder=dashboard_den(in)   % in=[drug_type drug_conc], holder=average
...
para_den=[80.455047279398968   1.073269211540708  88.599050737349799   0.004998720928621   0.167137548667601   0.876728114047647];
...
function out=mito_sys(t,y,c,drug)  %para=[k_etc   v_max_uncp k_uncp    k_atpase      k_mito  n_mito  v_max_atp ]  drug=[etc uncp atpase]
    ...
    -(para2(1)*HILL(atp_dec,para2(2),para2(3))+para2(4)*HILL(atp_dec,para2(5),para2(6)))*y(6)];% cell density
